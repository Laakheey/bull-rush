...
// import type { StockCardProps, StockChartProps } from '../interfaces/StockData';
...
// export const StockCard: React.FC<StockCardProps> = ({ stock, onClick, isSelected }) => {
...
//       ) : (
//         <>
//           <h3 className="text-2xl font-bold text-gray-800 mb-2">{stock.symbol}</h3>
//           <p className="text-3xl font-bold text-gray-900 mb-2">${stock.price.toFixed(2)}</p>
...
//         <p className="text-gray-500 text-lg">Select a stock to view detailed performance</p>
//       </div>
//     );
//   }
...
//         <h3 className="text-xl font-semibold mb-4">{symbol} - Price History</h3>
//         <ResponsiveContainer width="100%" height={400}>
//           <LineChart data={data}>
//             <CartesianGrid strokeDasharray="3 3" vertical={false} />
//             <XAxis dataKey="date" tick={{ fontSize: 12 }} />
//             <YAxis domain={['auto', 'auto']} tick={{ fontSize: 12 }} />
//             <Tooltip formatter={(value: any) => [formatPrice(value), 'Close']} />
//             <Legend />
...
//   ResponsiveContainer, BarChart, Bar, Cell, XAxis as BXAxis
// } from 'recharts';
// import { X } from 'lucide-react';
// import type { DefaultChartProps, StockCardProps, StockChartProps } from '../interfaces/types';
...
//           <p className="text-3xl font-bold text-gray-900 my-2">${stock.price?.toFixed(2)}</p>
//           <div className={`flex items-center font-bold ${isPositive ? 'text-green-600' : 'text-red-600'}`}>
//             <span>{isPositive ? '▲' : '▼'} {Math.abs(stock.change).toFixed(2)} ({Math.abs(stock.changePercent).toFixed(2)}%)</span>
//           </div>
//         </>
//       )}
//     </div>
...
// export const DefaultComparisonChart: React.FC<DefaultChartProps> = ({ data }) => (
//   <div className="bg-white p-6 rounded-xl shadow-lg animate-in fade-in slide-in-from-bottom-4 duration-700">
//     <h3 className="text-xl font-bold mb-6 text-gray-800 text-center md:text-left">Crypto Market Overview (USDT)</h3>
//     <ResponsiveContainer width="100%" height={400}>
//       <BarChart data={data}>
//         <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#f0f0f0" />
//         <BXAxis dataKey="name" axisLine={false} tickLine={false} />
...
// export const StockChart: React.FC<StockChartProps> = ({ data, symbol, onClose }) => {
//   const formatPrice = (v: number) => `$${v.toFixed(2)}`;
//   return (
...
//         <X size={24} />
//       </button>
//       <h3 className="text-xl font-bold mb-6 text-gray-800">{symbol} Performance</h3>
//       <ResponsiveContainer width="100%" height={400}>
//         <LineChart data={data}>
//           <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#f0f0f0" />
//           <XAxis dataKey="date" hide />
//           <YAxis domain={['auto', 'auto']} axisLine={false} tickLine={false} />
//           <Tooltip formatter={(value: any) => [formatPrice(value), 'Close Price']} />
//           <Line type="monotone" dataKey="close" stroke="#3b82f6" strokeWidth={3} dot={false} />
//         </LineChart>
//       </ResponsiveContainer>
//     </div>
