...
//       // 4. If PARTIAL withdrawal, create NEW active investment
...
//       // 5. Record transaction (optional)
//       await supabase.from("transactions").insert({
//         user_id: user.id,
//         amount: amount,
//         type: "credit",
//         description: `Withdrew ${amount} tokens from ${investment.plan_type} investment`,
